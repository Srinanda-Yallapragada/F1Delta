...
def relative_performance_view(track, driver, abbreviation):
    ...
    st.markdown(
        ...
        <p>This visualization compares the qualifying and race performance of {driver} against their teammate at {track} across 2024 and 2025.</p>
  
        <ul>
            <li><strong>Horizontal Lines</strong>: Connect qualifying position to race position for each driver</li>
            <li><strong>Arrows</strong>: Indicate the direction of position change from qualifying to race</li>
            
        </ul>

        </span>
        """.format(driver=driver, track=track),
