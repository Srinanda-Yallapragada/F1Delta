...
def rpm_vs_distance_fastest_lap_view(track, driver, abbreviation):
    ...
    st.markdown(
        """
        <span class='regular'>
        <h3>Understanding the RPM Comparison</h3>
        <p>This visualization compares the engine RPM (Revolutions Per Minute) between the driver's fastest qualifying laps in 2024 and 2025.</p>
        <ul>
            <li><strong>Higher RPM</strong> typically indicates more aggressive acceleration or higher engine stress. Especially at the end of long straights</li>
            The <strong>colored background highlights</strong> show where one year's lap had greater than one percent different RPM patterns,
            <li>Vertical lines mark corner locations, helping identify how RPM varies through different track sections</li>
        </ul>
        </span>
        """,
        unsafe_allow_html=True,
...
def fastest_qualifying_lap_speed_view(track, driver, abbreviation):
    ...
    st.markdown(
        """
        <span class='regular'>
        <h3>Understanding the Speed Comparison</h3>
        <p>This visualization overlays the speed profiles from the driver's fastest qualifying laps in 2024 and 2025.</p>
        <ul>
            <li><strong>Top Speed</strong>: Compare maximum speeds achieved across the lap</li>
            <li><strong>Corner Entry/Exit</strong>: Look at speed differences approaching and exiting corners</li>
            <li><strong>Colored Background</strong>: Highlights sections where one year's lap was at least 1 percent faster</li>
            <li><strong>Corner Markers</strong>: Vertical lines show corner locations for reference</li>
        </ul>
