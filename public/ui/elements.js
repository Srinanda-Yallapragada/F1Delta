export const selectTrackList = document.getElementById("track-list");
export const selectElement = document.getElementById("driver-selector"); //This is the drop down
export const driverNameElement = document.getElementById("driver-name"); //This is the text 
